package com.rongyi.order.apple;
 ...
 */
@RouterService(interfaces = OrderRpc.class, singleton = true, key = "apple")
public class AppleOrderImpl implements OrderRpc {

    @Override
    public void makeOrder(String id) {
        User user = Router.getService(InfoRpc.class).getUser();
        String hint = user.getName() + " has make an apple order, order id is:" + id;
