...
public final class PhoneUtils {
    ...
    public static void dial(@NonNull final String phoneNumber) {
        Utils.getApp().startActivity(UtilsCenter.getDialIntent(phoneNumber));
    }
    ...
    public static void call(@NonNull final String phoneNumber) {
        Utils.getApp().startActivity(UtilsCenter.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(@NonNull final String phoneNumber, final String content) {
        Utils.getApp().startActivity(UtilsCenter.getSendSmsIntent(phoneNumber, content));
    }
