...
public final class DeviceUtils {
    ...
    private static String getMacAddressByFile() {
        ShellUtils.CommandResult result = UtilsCenter.execCmd("getprop wifi.interface", false);
        if (result.result == 0) {
            String name = result.successMsg;
            if (name != null) {
                result = UtilsCenter.execCmd("cat /sys/class/net/" + name + "/address", false);
                if (result.result == 0) {
...
//        if (checkDebuggerConnected) return true;
    ...
    public static String getUniqueDeviceId(String prefix, boolean useCache) {
        ...
        if (udid == null) {
            synchronized (DeviceUtils.class) {
                if (udid == null) {
                    final String id = UtilsCenter.getSpUtils4Utils().getString(KEY_UDID, null);
                    if (id != null) {
                        udid = id;
                        return udid;
                    }
    ...
    public static boolean isSameDevice(final String uniqueDeviceId) {
        ...
        final String cachedId = UtilsCenter.getSpUtils4Utils().getString(KEY_UDID, null);
    ...
    private static String saveUdid(String prefix, String id) {
        ...
        UtilsCenter.getSpUtils4Utils().put(KEY_UDID, udid);
        return udid;
    }
