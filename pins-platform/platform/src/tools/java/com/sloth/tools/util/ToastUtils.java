...
public final class ToastUtils {
    ...
    public final void show(@StringRes final int resId) {
        show(UtilsCenter.getString(resId), getDuration(), this);
    }
    ...
    public final void show(@StringRes final int resId, final Object... args) {
        show(UtilsCenter.getString(resId, args), getDuration(), this);
    }
    ...
    public final void show(@Nullable final String format, final Object... args) {
        show(UtilsCenter.format(format, args), getDuration(), this);
    }
    ...
    private View tryApplyUtilsToastView(final CharSequence text) {
        ...
        View toastView = UtilsCenter.layoutId2View(R.layout.utils_toast_view);
    ...
    public static void showShort(@StringRes final int resId) {
        show(UtilsCenter.getString(resId), Toast.LENGTH_SHORT, DEFAULT_MAKER);
    }
    ...
    public static void showShort(@StringRes final int resId, final Object... args) {
        show(UtilsCenter.getString(resId, args), Toast.LENGTH_SHORT, DEFAULT_MAKER);
    }
    ...
    public static void showShort(@Nullable final String format, final Object... args) {
        show(UtilsCenter.format(format, args), Toast.LENGTH_SHORT, DEFAULT_MAKER);
    }
    ...
    public static void showLong(@StringRes final int resId) {
        show(UtilsCenter.getString(resId), Toast.LENGTH_LONG, DEFAULT_MAKER);
    }
    ...
    public static void showLong(@Nullable final String format, final Object... args) {
        show(UtilsCenter.format(format, args), Toast.LENGTH_LONG, DEFAULT_MAKER);
    }
    ...
    public static void cancel() {
        UtilsCenter.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                if (sWeakToast != null) {
    ...
    private static IToast newToast(ToastUtils toastUtils) {
        if (!toastUtils.isNotUseSystemToast) {
            if (NotificationManagerCompat.from(Utils.getApp()).areNotificationsEnabled()) {
                ...
                if (!UtilsCenter.isGrantedDrawOverlays()) {
                    return new SystemToast(toastUtils);
                }
            }
        }
        ...
        } else if (UtilsCenter.isGrantedDrawOverlays()) {
    ...
    static final class WindowManagerToast extends AbsToast {
        ...
        public void show(final int duration) {
            ...
            UtilsCenter.runOnUiThreadDelayed(new Runnable() {
                @Override
                public void run() {
                    cancel();
                }
    ...
    static final class ActivityToast extends AbsToast {
        ...
        public void show(int duration) {
            if (mToast == null) return;
            if (!UtilsCenter.isAppForeground()) {
                // try to use system toast
                iToast = showSystemToast(duration);
                return;
            }
            boolean hasAliveActivity = false;
            for (final Activity activity : UtilsCenter.getActivityList()) {
                if (!UtilsCenter.isActivityAlive(activity)) {
                    continue;
                }
                if (!hasAliveActivity) {
        ...
        public void cancel() {
            if (isShowing()) {
                ...
                for (Activity activity : UtilsCenter.getActivityList()) {
                    if (!UtilsCenter.isActivityAlive(activity)) {
                        continue;
                    }
        ...
        private void showWithActivityView(final Activity activity, final int index, boolean useAnim) {
            ...
            if (window != null) {
                ...
                lp.bottomMargin = mToast.getYOffset() + UtilsCenter.getNavBarHeight();
                lp.topMargin = mToast.getYOffset() + UtilsCenter.getStatusBarHeight();
        ...
        private void registerLifecycleCallback() {
            ...
            UtilsCenter.addActivityLifecycleCallbacks(mActivityLifecycleCallbacks);
        }

        private void unregisterLifecycleCallback() {
            UtilsCenter.removeActivityLifecycleCallbacks(mActivityLifecycleCallbacks);
    ...
    static abstract class AbsToast implements IToast {
        ...
        public void setToastView(CharSequence text) {
            ...
            if (mToastView == null || mToastView.findViewById(android.R.id.message) == null) {
                setToastView(UtilsCenter.layoutId2View(R.layout.utils_toast_view));
            }
        ...
        View getToastViewSnapshot(final int index) {
            Bitmap bitmap = UtilsCenter.view2Bitmap(mToastView);
    ...
    public static final class UtilsMaxWidthRelativeLayout extends RelativeLayout {
        ...
        private static final int SPACING = UtilsCenter.dp2px(80);
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            int widthMaxSpec = MeasureSpec.makeMeasureSpec(UtilsCenter.getAppScreenWidth() - SPACING, MeasureSpec.AT_MOST);
