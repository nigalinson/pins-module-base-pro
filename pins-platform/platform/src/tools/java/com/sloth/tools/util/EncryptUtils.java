...
public final class EncryptUtils {
    ...
    public static String encryptMD2ToString(final byte[] data) {
        return UtilsCenter.bytes2HexString(encryptMD2(data));
    }
    ...
    public static String encryptMD5ToString(final String data, final String salt) {
        ...
        if (salt == null) return UtilsCenter.bytes2HexString(encryptMD5(data.getBytes()));
        if (data == null) return UtilsCenter.bytes2HexString(encryptMD5(salt.getBytes()));
        return UtilsCenter.bytes2HexString(encryptMD5((data + salt).getBytes()));
    }
    ...
    public static String encryptMD5ToString(final byte[] data) {
        return UtilsCenter.bytes2HexString(encryptMD5(data));
    }
    ...
    public static String encryptMD5ToString(final byte[] data, final byte[] salt) {
        if (data == null && salt == null) return "";
        if (salt == null) return UtilsCenter.bytes2HexString(encryptMD5(data));
        if (data == null) return UtilsCenter.bytes2HexString(encryptMD5(salt));
        byte[] dataSalt = new byte[data.length + salt.length];
        System.arraycopy(data, 0, dataSalt, 0, data.length);
        System.arraycopy(salt, 0, dataSalt, data.length, salt.length);
        return UtilsCenter.bytes2HexString(encryptMD5(dataSalt));
    }
    ...
    public static String encryptMD5File2String(final String filePath) {
        File file = UtilsCenter.isSpace(filePath) ? null : new File(filePath);
    ...
    public static String encryptMD5File2String(final File file) {
        return UtilsCenter.bytes2HexString(encryptMD5File(file));
    }
    ...
    public static String encryptSHA1ToString(final byte[] data) {
        return UtilsCenter.bytes2HexString(encryptSHA1(data));
    }
    ...
    public static String encryptSHA224ToString(final byte[] data) {
        return UtilsCenter.bytes2HexString(encryptSHA224(data));
    }
    ...
    public static String encryptSHA256ToString(final byte[] data) {
        return UtilsCenter.bytes2HexString(encryptSHA256(data));
    }
    ...
    public static String encryptSHA384ToString(final byte[] data) {
        return UtilsCenter.bytes2HexString(encryptSHA384(data));
    }
    ...
    public static String encryptSHA512ToString(final byte[] data) {
        return UtilsCenter.bytes2HexString(encryptSHA512(data));
    }
    ...
    public static String encryptHmacMD5ToString(final byte[] data, final byte[] key) {
        return UtilsCenter.bytes2HexString(encryptHmacMD5(data, key));
    }
    ...
    public static String encryptHmacSHA1ToString(final byte[] data, final byte[] key) {
        return UtilsCenter.bytes2HexString(encryptHmacSHA1(data, key));
    }
    ...
    public static String encryptHmacSHA224ToString(final byte[] data, final byte[] key) {
        return UtilsCenter.bytes2HexString(encryptHmacSHA224(data, key));
    }
    ...
    public static String encryptHmacSHA256ToString(final byte[] data, final byte[] key) {
        return UtilsCenter.bytes2HexString(encryptHmacSHA256(data, key));
    }
    ...
    public static String encryptHmacSHA384ToString(final byte[] data, final byte[] key) {
        return UtilsCenter.bytes2HexString(encryptHmacSHA384(data, key));
    }
    ...
    public static String encryptHmacSHA512ToString(final byte[] data, final byte[] key) {
        return UtilsCenter.bytes2HexString(encryptHmacSHA512(data, key));
    }
    ...
    public static byte[] encryptDES2Base64(final byte[] data,
                                           ...
                                           final byte[] iv) {
        return UtilsCenter.base64Encode(encryptDES(data, key, transformation, iv));
    }
    ...
    public static String encryptDES2HexString(final byte[] data,
                                              ...
                                              final String transformation,
                                              final byte[] iv) {
        return UtilsCenter.bytes2HexString(encryptDES(data, key, transformation, iv));
    }
    ...
    public static byte[] decryptBase64DES(final byte[] data,
                                          ...
                                          final String transformation,
                                          final byte[] iv) {
        return decryptDES(UtilsCenter.base64Decode(data), key, transformation, iv);
    }
    ...
    public static byte[] decryptHexStringDES(final String data,
                                             ...
                                             final String transformation,
                                             final byte[] iv) {
        return decryptDES(UtilsCenter.hexString2Bytes(data), key, transformation, iv);
    }
    ...
    public static byte[] encrypt3DES2Base64(final byte[] data,
                                            ...
                                            final String transformation,
                                            final byte[] iv) {
        return UtilsCenter.base64Encode(encrypt3DES(data, key, transformation, iv));
    }
    ...
    public static String encrypt3DES2HexString(final byte[] data,
                                               ...
                                               final String transformation,
                                               final byte[] iv) {
        return UtilsCenter.bytes2HexString(encrypt3DES(data, key, transformation, iv));
    }
    ...
    public static byte[] decryptBase64_3DES(final byte[] data,
                                            ...
                                            final String transformation,
                                            final byte[] iv) {
        return decrypt3DES(UtilsCenter.base64Decode(data), key, transformation, iv);
    }
    ...
    public static byte[] decryptHexString3DES(final String data,
                                              ...
                                              final String transformation,
                                              final byte[] iv) {
        return decrypt3DES(UtilsCenter.hexString2Bytes(data), key, transformation, iv);
    }
    ...
    public static byte[] encryptAES2Base64(final byte[] data,
                                           ...
                                           final String transformation,
                                           final byte[] iv) {
        return UtilsCenter.base64Encode(encryptAES(data, key, transformation, iv));
    }
    ...
    public static String encryptAES2HexString(final byte[] data,
                                              ...
                                              final String transformation,
                                              final byte[] iv) {
        return UtilsCenter.bytes2HexString(encryptAES(data, key, transformation, iv));
    }
    ...
    public static byte[] decryptBase64AES(final byte[] data,
                                          ...
                                          final String transformation,
                                          final byte[] iv) {
        return decryptAES(UtilsCenter.base64Decode(data), key, transformation, iv);
    }
    ...
    public static byte[] decryptHexStringAES(final String data,
                                             ...
                                             final String transformation,
                                             final byte[] iv) {
        return decryptAES(UtilsCenter.hexString2Bytes(data), key, transformation, iv);
    }
    ...
    public static byte[] encryptRSA2Base64(final byte[] data,
                                           ...
                                           final int keySize,
                                           final String transformation) {
        return UtilsCenter.base64Encode(encryptRSA(data, publicKey, keySize, transformation));
    }
    ...
    public static String encryptRSA2HexString(final byte[] data,
                                              ...
                                              final int keySize,
                                              final String transformation) {
        return UtilsCenter.bytes2HexString(encryptRSA(data, publicKey, keySize, transformation));
    }
    ...
    public static byte[] decryptBase64RSA(final byte[] data,
                                          ...
                                          final int keySize,
                                          final String transformation) {
        return decryptRSA(UtilsCenter.base64Decode(data), privateKey, keySize, transformation);
    }
    ...
    public static byte[] decryptHexStringRSA(final String data,
                                             ...
                                             final int keySize,
                                             final String transformation) {
        return decryptRSA(UtilsCenter.hexString2Bytes(data), privateKey, keySize, transformation);
    }
