...
public class MessengerUtils {
    ...
    public static void register() {
        if (UtilsCenter.isMainProcess()) {
            if (UtilsCenter.isServiceRunning(ServerService.class.getName())) {
    ...
    static class Client {
        ...
        ServiceConnection mConn   = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                int key = UtilsCenter.getCurrentProcessName().hashCode();
        ...
        boolean bind() {
            ...
            if (UtilsCenter.isAppInstalled(mPkgName)) {
                if (UtilsCenter.isAppRunning(mPkgName)) {
    ...
    public static class ServerService extends Service {
        ...
        public int onStartCommand(Intent intent, int flags, int startId) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                Notification notification = UtilsCenter.getNotification(
