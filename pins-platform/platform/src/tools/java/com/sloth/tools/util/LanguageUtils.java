...
public class LanguageUtils {
    ...
    private static void applyLanguageReal(final Locale locale,
                                          final boolean isRelaunchApp) {
        if (locale == null) {
            UtilsCenter.getSpUtils4Utils().put(KEY_LOCALE, VALUE_FOLLOW_SYSTEM, true);
        } else {
            UtilsCenter.getSpUtils4Utils().put(KEY_LOCALE, locale2String(locale), true);
        }
    ...
    public static Locale getAppliedLanguage() {
        final String spLocaleStr = UtilsCenter.getSpUtils4Utils().getString(KEY_LOCALE);
    ...
    public static Context attachBaseContext(Context context) {
        String spLocaleStr = UtilsCenter.getSpUtils4Utils().getString(KEY_LOCALE);
        if (TextUtils.isEmpty(spLocaleStr) || VALUE_FOLLOW_SYSTEM.equals(spLocaleStr)) {
            return context;
        }
    ...
    static void applyLanguage(final Activity activity) {
        String spLocale = UtilsCenter.getSpUtils4Utils().getString(KEY_LOCALE);
    ...
    private static Locale string2Locale(String str) {
        ...
        if (locale == null) {
            ...
            UtilsCenter.getSpUtils4Utils().remove(KEY_LOCALE);
        }
        return locale;
    }
    ...
    private static boolean isSameLocale(Locale l0, Locale l1) {
        return UtilsCenter.equals(l1.getLanguage(), l0.getLanguage())
                && UtilsCenter.equals(l1.getCountry(), l0.getCountry());
    }
