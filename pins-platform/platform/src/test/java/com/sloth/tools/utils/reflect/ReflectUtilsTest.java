package com.sloth.tools.utils.reflect;
...
public class ReflectUtilsTest {
    ...
    public void fieldPrivateStaticFinal() {
        assertEquals(Integer.valueOf(1), ReflectUtils.reflect(TestPrivateStaticFinal.class).field("I1").get());
