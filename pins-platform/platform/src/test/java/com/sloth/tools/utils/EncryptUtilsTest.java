...
import com.sloth.tools.util.EncryptUtils;
import com.sloth.tools.util.UtilsCenter;
...
import static com.sloth.tools.utils.TestConfig.PATH_ENCRYPT;
...
public class EncryptUtilsTest extends BaseTest {
    ...
    public void encryptMD2() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjMD2),
    ...
    public void encryptMD5() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjMD5),
    ...
    public void encryptSHA1() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjSHA1),
    ...
    public void encryptSHA224() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjSHA224),
    ...
    public void encryptSHA256() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjSHA256),
    ...
    public void encryptSHA384() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjSHA384),
    ...
    public void encryptSHA512() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjSHA512),
    ...
    public void encryptHmacMD5() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjHmacMD5),
    ...
    public void encryptHmacSHA1() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjHmacSHA1),
    ...
    public void encryptHmacSHA224() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjHmacSHA224),
    ...
    public void encryptHmacSHA256() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjHmacSHA256),
    ...
    public void encryptHmacSHA384() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjHmacSHA384),
    ...
    public void encryptHmacSHA512() {
        ...
        assertArrayEquals(
                UtilsCenter.hexString2Bytes(blankjHmacSHA512),
    ...
    private byte[] bytesDataDES = UtilsCenter.hexString2Bytes(dataDES);
    private byte[] bytesKeyDES  = UtilsCenter.hexString2Bytes(keyDES);
    private byte[] bytesResDES  = UtilsCenter.hexString2Bytes(resDES);
    ...
    public void encryptDES() {
        ...
        assertArrayEquals(
                UtilsCenter.base64Encode(bytesResDES),
    ...
    public void decryptDES() {
        ...
        assertArrayEquals(
                bytesDataDES,
                EncryptUtils.decryptBase64DES(UtilsCenter.base64Encode(bytesResDES), bytesKeyDES, "DES/ECB/NoPadding", null)
        );
    }
    ...
    private byte[] bytesDataDES3 = UtilsCenter.hexString2Bytes(data3DES);
    private byte[] bytesKeyDES3  = UtilsCenter.hexString2Bytes(key3DES);
    private byte[] bytesResDES3  = UtilsCenter.hexString2Bytes(res3DES);
    ...
    public void encrypt3DES() {
        ...
        assertArrayEquals(
                UtilsCenter.base64Encode(bytesResDES3),
    ...
    public void decrypt3DES() {
        ...
        assertArrayEquals(
                bytesDataDES3,
                EncryptUtils.decryptBase64_3DES(UtilsCenter.base64Encode(bytesResDES3), bytesKeyDES3, "DESede/ECB/NoPadding", null)
        );
    }
    ...
    private byte[] bytesDataAES = UtilsCenter.hexString2Bytes(dataAES);
    private byte[] bytesKeyAES  = UtilsCenter.hexString2Bytes(keyAES);
    private byte[] bytesResAES  = UtilsCenter.hexString2Bytes(resAES);
    ...
    public void encryptAES() {
        ...
        assertArrayEquals(
                UtilsCenter.base64Encode(bytesResAES),
    ...
    public void decryptAES() {
        ...
        assertArrayEquals(bytesDataAES,
                EncryptUtils.decryptBase64AES(UtilsCenter.base64Encode(bytesResAES), bytesKeyAES, "AES/ECB/PKCS5Padding", null)
        );
    }
    ...
    public void encryptDecryptRSA() throws Exception {
        ...
        System.out.println(EncryptUtils.encryptRSA2HexString(
                dataRSA.getBytes(),
                UtilsCenter.base64Decode(publicKey.getBytes()),
                keySize,
        ...
        assertArrayEquals(EncryptUtils.decryptRSA(
                ...
                UtilsCenter.base64Decode(privateKey.getBytes()),
                keySize,
                "RSA/None/PKCS1Padding"
        ), dataRSA.getBytes());
    }
