...
public final class SDCardUtils {
    ...
    public static long getExternalTotalSize() {
        return UtilsCenter.getFsTotalSize(getSDCardPathByEnvironment());
    }
    ...
    public static long getExternalAvailableSize() {
        return UtilsCenter.getFsAvailableSize(getSDCardPathByEnvironment());
    }
    ...
    public static long getInternalTotalSize() {
        return UtilsCenter.getFsTotalSize(Environment.getDataDirectory().getAbsolutePath());
    }
    ...
    public static long getInternalAvailableSize() {
        return UtilsCenter.getFsAvailableSize(Environment.getDataDirectory().getAbsolutePath());
    }
    ...
    public static class SDCardInfo {
        ...
        SDCardInfo(String path, String state, boolean isRemovable) {
            ...
            this.totalSize = UtilsCenter.getFsTotalSize(path);
            this.availableSize = UtilsCenter.getFsAvailableSize(path);
        }
