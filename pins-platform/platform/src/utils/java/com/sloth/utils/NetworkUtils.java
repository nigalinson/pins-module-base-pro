...
public final class NetworkUtils {
    ...
    public static Utils.Task<Boolean> isAvailableAsync(@NonNull final Utils.Consumer<Boolean> consumer) {
        return UtilsCenter.doAsync(new Utils.Task<Boolean>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static Utils.Task<String> getIPAddressAsync(final boolean useIPv4,
        ...
        return UtilsCenter.doAsync(new Utils.Task<String>(consumer) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    private static boolean isSameScanResultContent(ScanResult r1, ScanResult r2) {
        return r1 != null && r2 != null && UtilsCenter.equals(r1.BSSID, r2.BSSID)
                && UtilsCenter.equals(r1.SSID, r2.SSID)
                && UtilsCenter.equals(r1.capabilities, r2.capabilities)
                && r1.level == r2.level;
    }
...
//            Components.log().d(TAG, "onAvailable: " + network);
//        }
//
//        @Override
//        public void onLosing(@NonNull Network network, int maxMsToLive) {
//            super.onLosing(network, maxMsToLive);
//            Components.log().d(TAG, "onLosing: " + network);
//        }
//
//        @Override
//        public void onLost(@NonNull Network network) {
//            super.onLost(network);
//            Components.log().e(TAG, "onLost: " + network);
//        }
//
//        @Override
//        public void onUnavailable() {
//            super.onUnavailable();
//            Components.log().e(TAG, "onUnavailable");
//        }
//
//        @Override
...
//                    Components.log().d(TAG, "onCapabilitiesChanged: 网络类型为wifi");
//                } else if (cap.hasTransport(NetworkCapabilities.TRANSPORT_CELLULAR)) {
//                    Components.log().d(TAG, "onCapabilitiesChanged: 蜂窝网络");
//                } else {
//                    Components.log().d(TAG, "onCapabilitiesChanged: 其他网络");
//                }
//                Components.log().d(TAG, "onCapabilitiesChanged: " + network + ", " + cap);
//            }
//        }
//
//        @Override
...
//            Components.log().d(TAG, "onLinkPropertiesChanged: " + network + ", " + lp);
//        }
//
//        @Override
//        public void onBlockedStatusChanged(@NonNull Network network, boolean blocked) {
//            super.onBlockedStatusChanged(network, blocked);
//            Components.log().d(TAG, "onBlockedStatusChanged: " + network + ", " + blocked);
//        }
//
//        private static class LazyHolder {
