...
import com.sloth.platform.constants.Constants.PermissionConstants;
...
public final class PermissionUtils {
    ...
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        ...
        if (!UtilsCenter.isIntentAvailable(intent)) {
    ...
    public static void launchAppDetailsSettings() {
        Intent intent = UtilsCenter.getLaunchAppDetailsSettingsIntent(Utils.getApp().getPackageName(), true);
    ...
    private void rationalInner(final UtilsTransActivity activity, final Runnable againRunnable) {
        ...
        mOnRationaleListener.rationale(activity, again -> {
            if (again) {
                mPermissionsDenied = new ArrayList<>();
                mPermissionsDeniedForever = new ArrayList<>();
                againRunnable.run();
