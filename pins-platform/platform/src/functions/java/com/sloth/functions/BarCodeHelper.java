...
import com.rongyi.common.constant.AppDirectoryConstant;
 ...
 * Author:    Cao Kang
 * Version    V1.0
 * Date:      2015/5/26  15:03.
 * Description:生成条形码及二维码帮助类
 * Modification  History:
 * Date         	Author        		Version        	Description
 * -----------------------------------------------------------------------------------
 * 2015/5/26        Cao Kang            1.0                    1.0
...
//            }
    ...
    public static String createQRImageToFile(String url, int img_width, int img_height) {
        try {
            ...
            bitmap.setPixels(pixels, 0, img_width, 0, 0, img_width, img_height);
            String filePath = AppDirectoryConstant.APP_COMMON_DIRECTORY + System.currentTimeMillis() + ".jpg";
