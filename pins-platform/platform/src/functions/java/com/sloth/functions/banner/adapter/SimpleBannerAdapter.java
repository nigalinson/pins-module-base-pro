...
import com.rongyi.common.functions.image.RYImageLoader;
...
import com.rongyi.common.widget.banner.vh.PagerViewHolder;
import com.rongyi.common.widget.banner.vh.PlayerViewHolder;
...
public class SimpleBannerAdapter<T extends Playable> extends BannerAdapter<RYBaseViewHolder<T>, T> {
    ...
    public static class SimpleWebViewViewHolder<T extends Playable> extends PagerViewHolder<T> implements AutoDispose.AutoDisposable {
        ...
        public void bindViewData(T data) {
            if(webView != null){
                if(FZStringHelper.notEmpty(data.localPath())){
                    webView.loadUrl(data.localPath());
                }else if(FZStringHelper.notEmpty(data.webUrl())){
