package com.sloth.functions.widget.rounded;
...
public class RoundedTextView extends AppCompatTextView {
    ...
    public static final String TAG = "RoundedTextView";
    ...
    public RoundedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int index = a.getInt(R.styleable.RoundedTextView_android_scaleType, -1);
        if (index >= 0) {
        ...
        float cornerRadiusOverride =
                a.getDimensionPixelSize(R.styleable.RoundedTextView_rtv_corner_radius, -1);

        mCornerRadii[Corner.TOP_LEFT] =
                a.getDimensionPixelSize(R.styleable.RoundedTextView_rtv_corner_radius_top_left, -1);
        mCornerRadii[Corner.TOP_RIGHT] =
                a.getDimensionPixelSize(R.styleable.RoundedTextView_rtv_corner_radius_top_right, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] =
                a.getDimensionPixelSize(R.styleable.RoundedTextView_rtv_corner_radius_bottom_right, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] =
                a.getDimensionPixelSize(R.styleable.RoundedTextView_rtv_corner_radius_bottom_left, -1);
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.RoundedTextView_rtv_border_width, -1);
        if (mBorderWidth < 0) {
        ...
        mMutateBackground = a.getBoolean(R.styleable.RoundedTextView_rtv_mutate_background, false);
        mIsOval = a.getBoolean(R.styleable.RoundedTextView_rtv_oval, false);

        final int tileMode = a.getInt(R.styleable.RoundedTextView_rtv_tile_mode, TILE_MODE_UNDEFINED);
        ...
        final int tileModeX =
                a.getInt(R.styleable.RoundedTextView_rtv_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY =
                a.getInt(R.styleable.RoundedTextView_rtv_tile_mode_y, TILE_MODE_UNDEFINED);
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                LogUtils.w(TAG, "Unable to find resource: " + mResource);
                // Don't try again.
                mResource = 0;
            }
        }
    ...
    private Drawable resolveBackgroundResource() {
        ...
        if (mBackgroundResource != 0) {
            try {
                ...
                LogUtils.w(TAG, "Unable to find resource: " + mBackgroundResource);
                // Don't try again.
