 ...
 */
public class FadeLayoutManager extends AbstractBannerLayoutManager {

    public FadeLayoutManager(Context context) {
        super(context);
    }

    public FadeLayoutManager(Context context, int orientation, boolean reverseLayout) {
