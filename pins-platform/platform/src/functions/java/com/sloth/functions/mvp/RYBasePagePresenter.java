 ...
 */
public abstract class RYBasePagePresenter<V extends RYBasePageView> extends RYBasePresenter<V> {

    protected final Paging paging = new Paging();

    public RYBasePagePresenter(V view) {
        super(view);
    }

    public RYBasePagePresenter(Context context, V view) {
        super(context, view);
    }
