 ...
 */
public class RyPlayerNativeTextureView extends FrameLayout implements IRyPlayer,
    ...
    private static final String TAG = RyPlayerNativeTextureView.class.getSimpleName();
    ...
    public RyPlayerNativeTextureView(@NonNull Context context) {
        this(context, null);
    }

    public RyPlayerNativeTextureView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public RyPlayerNativeTextureView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
